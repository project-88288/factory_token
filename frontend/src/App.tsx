...
import { FactoryTokenClient } from './contract/clients/FactoryTokenClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new FactoryTokenClient(lcd, connectedWallet, contractAddress('factory_token', connectedWallet));
  }, [lcd, connectedWallet]);
