...
export interface FactoryTokenReadOnlyInterface {
  contractAddress: string;
  getMintedTokensQuery: () => Promise<MintedTokensResponse>;
}
export class FactoryTokenQueryClient implements FactoryTokenReadOnlyInterface {
  client: LCDClient;
  contractAddress: string;
...
export interface FactoryTokenInterface extends FactoryTokenReadOnlyInterface {
  contractAddress: string;
...
export class FactoryTokenClient extends FactoryTokenQueryClient implements FactoryTokenInterface {
  client: LCDClient;
